    ...
    match msg {
        ...
        EventMsg::CollabAgentSpawnBegin(begin_event) => {
            let item = ThreadItem::CollabAgentToolCall {
                ...
                prompt: Some(spawn_display_prompt(
                    &begin_event.prompt,
                    begin_event.task_name.as_deref(),
                )),
...
fn spawn_display_prompt(prompt: &str, task_name: Option<&str>) -> String {
...
mod tests {
    ...
    #[test]
    fn collab_spawn_begin_uses_task_name_when_prompt_is_hidden() {
        let event = CollabAgentSpawnBeginEvent {
            call_id: "call-spawn".to_string(),
            started_at_ms: 789,
            sender_thread_id: ThreadId::new(),
            prompt: String::new(),
            task_name: Some("discover_models".to_string()),
            model: "Chitti-Smart".to_string(),
            reasoning_effort: ReasoningEffortConfig::XHigh,
        };
        ...
        assert_item_started_server_notification(
            ...
            ItemStartedNotification {
                ...
                item: ThreadItem::CollabAgentToolCall {
                    ...
                    sender_thread_id: event.sender_thread_id.to_string(),
                    receiver_thread_ids: Vec::new(),
                    prompt: Some("task: discover_models".to_string()),
