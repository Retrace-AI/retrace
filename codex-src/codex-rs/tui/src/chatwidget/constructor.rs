...
impl ChatWidget {
    ...
    pub(super) fn new_with_op_target(
        ...
        let mut widget = Self {
            ...
            thinking_display_override: ChatWidget::load_thinking_display_override(
                &config.codex_home,
            ),
            model_probe_spinner_active: false,
            pending_mode_gate_override: None,
            ...
            pending_model_sizing_limits: HashMap::new(),
            ...
            live_collab_agent_status: multi_agents::LiveAgentStatus::default(),
            ...
            assistant_thinking_filter_buffer: String::new(),
            assistant_thinking_filter_inside: false,
            assistant_inline_reasoning_buffer: String::new(),
