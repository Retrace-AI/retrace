...
pub(super) async fn make_chatwidget_manual(
    ...
    widget.normal_placeholder_text = "Ask Retrace to do anything".to_string();
...
pub(super) fn plugins_test_curated_marketplace(
    ...
    PluginMarketplaceEntry {
        ...
        interface: Some(MarketplaceInterface {
            display_name: Some("Retrace Marketplace".to_string()),
        }),
        plugins,
    }
}
...
pub(super) fn plugins_test_detail(
    ...
    PluginDetail {
        marketplace_name: "Retrace Marketplace".to_string(),
