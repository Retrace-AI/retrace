...
impl ChatWidget {
    ...
    pub(super) fn approval_preset_actions(
        ...
        vec![Box::new(move |tx| {
            ...
            // An explicit preset choice becomes the restore point for gated
            // collaboration modes (processed after the updates above land).
            tx.send(AppEvent::MarkUserPermissionBaseline);
    ...
    pub(crate) fn open_full_access_confirmation(
        ...
        let info_line = Line::from(vec![
            "When Retrace runs with full access, it can edit any file on your computer and run commands with network, without your approval. "
                .into(),
