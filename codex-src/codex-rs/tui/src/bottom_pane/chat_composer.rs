...
use super::footer::passive_footer_status_line_with_mode_prefix;
...
impl ChatComposer {
    ...
    pub(crate) fn animated_collaboration_mode_indicator_delay(&self) -> Option<Duration> {
        self.footer
            .collaboration_mode_indicator
            .and_then(CollaborationModeIndicator::animation_frame_delay)
    }
...
mod tests {
    ...
    fn footer_hint_row_is_separated_from_composer() {
        ...
        let composer = ChatComposer::new(
            ...
            "Ask Retrace to do anything".to_string(),
    ...
    fn set_skill_mentions_refreshes_open_mention_popup() {
        ...
        composer.set_skill_mentions(Some(vec![SkillMetadata {
            ...
            description: "Primary personal Retrace repo skill.".to_string(),
