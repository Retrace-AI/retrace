...
impl TerminalTitleItem {
    fn is_tui_visible(self) -> bool {
        !matches!(self, TerminalTitleItem::FastMode)
    }

    pub(crate) fn description(self) -> &'static str {
        match self {
            TerminalTitleItem::AppName => "Retrace app name",
            ...
            TerminalTitleItem::CodexVersion => "Retrace application version",
...
impl TerminalTitleSetupView {
    ...
    pub(crate) fn new(
        ...
        let selected_items = title_items
            ...
            .filter(|item| item.is_tui_visible())
            .unique()
            .collect_vec();
