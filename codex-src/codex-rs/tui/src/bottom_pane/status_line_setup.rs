...
pub(crate) enum StatusLineItem {
    ...
    /// Total cached input tokens served from the provider's prompt cache.
    TotalCachedTokens,
...
impl StatusLineItem {
    fn is_tui_visible(self) -> bool {
        !matches!(self, StatusLineItem::FastMode)
    }
    ...
    pub(crate) fn description(self) -> &'static str {
        match self {
            ...
            StatusLineItem::CodexVersion => "Retrace application version",
            ...
            StatusLineItem::TotalCachedTokens => {
                "Total cached input tokens served from the provider prompt cache (omitted when zero)"
            }
    ...
    pub(crate) fn preview_item(self) -> StatusSurfacePreviewItem {
        match self {
            ...
            StatusLineItem::TotalCachedTokens => StatusSurfacePreviewItem::TotalCachedTokens,
