...
pub fn get_upgrade_version(config: &Config) -> Option<String> {
    // Retrace is distributed from this fork's own builds; never advertise the
    // upstream installer as an update path.
    let retrace_updates_disabled = true;
    if retrace_updates_disabled
