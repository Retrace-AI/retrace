...
impl AuthModeWidget {
    ...
    fn render_pick_mode(&self, area: Rect, buf: &mut Buffer) {
        let mut lines: Vec<Line> = vec![
            Line::from(vec![
                "  ".into(),
                "Sign in with Retrace to use Retrace as part of your paid plan".into(),
            ]),
            Line::from(vec![
                "  ".into(),
        ...
        if !self.is_api_login_allowed() {
            lines.push(
                "  API key login is disabled by this workspace. Sign in with Retrace to continue."
                    .dim()
                    .into(),
            );
            lines.push("".into());
    ...
    fn render_chatgpt_success_message(&self, area: Rect, buf: &mut Buffer) {
        let lines = vec![
            "✓ Signed in with your Retrace account"
                .fg(Color::Green)
                .into(),
            "".into(),
            "  Before you start:".into(),
            "".into(),
            "  Decide how much autonomy you want to grant Retrace".into(),
            Line::from(vec![
            ...
            .dim(),
            "".into(),
            "  Retrace can make mistakes".into(),
            "  Review the code it writes and commands it runs"
                .dim()
                .into(),
            "".into(),
            "  Powered by your Retrace account".into(),
            Line::from(vec![
    ...
    fn render_api_key_configured(&self, area: Rect, buf: &mut Buffer) {
        let lines = vec![
            ...
            "".into(),
            "  Retrace will use usage-based billing with your API key.".into(),
        ];
    ...
    fn render_api_key_entry(&self, area: Rect, buf: &mut Buffer, state: &ApiKeyInputState) {
        ...
        let mut intro_lines: Vec<Line> = vec![
            Line::from(vec![
                "> ".into(),
                "Use your own Retrace API key for usage-based billing".bold(),
            ]),
            "".into(),
