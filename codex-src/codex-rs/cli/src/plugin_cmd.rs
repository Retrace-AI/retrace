...
#[derive(Debug, Parser)]
#[command(bin_name = "retrace-tui plugin")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "retrace-tui plugin add",
    after_help = "Examples:\n  retrace-tui plugin add sample@debug\n  retrace-tui plugin add sample --marketplace debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "retrace-tui plugin list",
    after_help = "Examples:\n  retrace-tui plugin list\n  retrace-tui plugin list --marketplace debug\n  retrace-tui plugin list --json\n  retrace-tui plugin list --available --json"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "retrace-tui plugin remove",
    after_help = "Examples:\n  retrace-tui plugin remove sample@debug\n  retrace-tui plugin remove sample --marketplace debug"
)]
