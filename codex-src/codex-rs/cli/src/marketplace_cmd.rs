...
#[derive(Debug, Parser)]
#[command(bin_name = "retrace-tui plugin marketplace")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "retrace-tui plugin marketplace add",
    after_help = "Examples:\n  retrace-tui plugin marketplace add ./path/to/marketplace\n  retrace-tui plugin marketplace add owner/repo --ref main\n  retrace-tui plugin marketplace add https://github.com/owner/repo --sparse plugins/foo"
)]
...
#[derive(Debug, Parser)]
#[command(bin_name = "retrace-tui plugin marketplace list")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "retrace-tui plugin marketplace upgrade",
    after_help = "Examples:\n  retrace-tui plugin marketplace upgrade\n  retrace-tui plugin marketplace upgrade debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "retrace-tui plugin marketplace remove",
    after_help = "Example:\n  retrace-tui plugin marketplace remove debug"
)]
