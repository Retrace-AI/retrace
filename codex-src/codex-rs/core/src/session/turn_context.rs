...
impl Session {
    ...
    async fn new_turn_context_from_configuration(
        ...
        let multi_agent_version = collaboration_mode_multi_agent_version(
            session_configuration.collaboration_mode.mode,
            multi_agent_version,
        );
...
fn collaboration_mode_multi_agent_version(
    mode: ModeKind,
    selected: MultiAgentVersion,
) -> MultiAgentVersion {
    match mode {
        ModeKind::AbsoluteRampage | ModeKind::ReadonlyResearch => MultiAgentVersion::V2,
        _ => selected,
    }
}
...
mod tests {
    ...
    #[test]
    fn rampage_and_readonly_research_use_multi_agent_v2_when_collab_is_available() {
        assert_eq!(
            collaboration_mode_multi_agent_version(
    ...
    #[test]
    fn rampage_enables_multi_agent_v2_even_when_base_selection_is_disabled() {
        assert_eq!(
            collaboration_mode_multi_agent_version(
                ModeKind::AbsoluteRampage,
    ...
    #[test]
    fn build_mode_keeps_selected_multi_agent_version() {
        assert_eq!(
            collaboration_mode_multi_agent_version(ModeKind::Default, MultiAgentVersion::V1),
            MultiAgentVersion::V1
        );
    }
}
