...
impl ModeKind {
    pub const fn display_name(self) -> &'static str {
        match self {
            ...
            Self::Plan => "Plan",
            Self::Default => "Build",
            Self::AbsoluteRampage => "Absolute Rampage",
            Self::ReadonlyResearch => "Readonly Research",
    ...
    pub const fn is_tui_visible(self) -> bool {
        matches!(
            self,
            Self::Ask | Self::Plan | Self::Default | Self::AbsoluteRampage | Self::ReadonlyResearch
        )
    }
    ...
    pub const fn allows_request_user_input(self) -> bool {
        matches!(
            self,
            Self::Plan | Self::ReadonlyResearch | Self::AbsoluteRampage
        )
    }
}
