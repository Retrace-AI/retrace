...
const DEFAULT_PERSONALITY_HEADER: &str = "You are {{BRAND}}, an interactive CLI coding agent. You and the user share the same workspace and collaborate to achieve the user's goals.";
